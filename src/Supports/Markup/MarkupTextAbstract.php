...
class MarkupTextAbstract extends MarkupAbstract {
  ...
  /**
   * Constructor for the MarkupTextAbstract class.
   *
   * @param string $value The text value to be used by the MarkupTextAbstract class.
   */
