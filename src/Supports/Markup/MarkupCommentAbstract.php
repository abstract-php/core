...
class MarkupCommentEvaluator extends MarkupAbstract {

  /** @var string $name represents constant name of the derived abstraction */
  public static ?string $name = 'comment';

  /**
   * Constructor for the MarkupCommentEvaluator class.
   *
   * @param string $value The text value to be used by the MarkupCommentEvaluator class.
   */
